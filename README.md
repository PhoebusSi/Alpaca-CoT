...
| [dolly](https://github.com/databrickslabs/dolly)                               | 15015    | EN           | TS        | HG         | closed QA , summarization and etc, Wikipedia as references               | human annotated                                                                | [download](https://huggingface.co/datasets/QingyiSi/Alpaca-CoT/tree/main/dolly)                 |
...
| TODO |
| [FastChat](https://github.com/lm-sys/FastChat/issues/90#issuecomment-1493250773)|         | EN           | MT        | MIX        | general instruct                                                         | crowdsourcing to collect conversations between people and ChatGPT (ShareGPT)   |                                                                                                 |
