...
| [FastChat](https://github.com/lm-sys/FastChat)                                 | 51974    | EN           | MT        | MIX        | 通用指令                         | 众包收集ChatGPT与人的交互 (ShareGPT)                 | [下载](https://huggingface.co/datasets/QingyiSi/Alpaca-CoT/tree/main/FastChat)        |
